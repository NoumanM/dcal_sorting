...
file_name = f'DCAL-output-{date.today()}.csv'
...
all_columns_names = []
for file in files:
    if '.csv' in file and 'output' not in file and file != 'DCAL_g_name_and_spec.csv' and '.pdf' not in file:
            ...
            for one_county in one_state_data.keys():
                ...
                for group in one_country_data.keys():
                    ...
                    for addresses in one_group_data.keys():
                        d = one_group_data[addresses]
                        for data in d:
                            if (data['ProviderType'] != 'PCP' and data['ProviderType'] != 'BehavioralHealthSpecialist' and data['Specialty'] not in dental_provider and data[
                                    'Specialty'] != 'Pharmacy' and data['ProviderType'] != 'NULL' and data['ProviderType'] != 'Facility' and data[
                                    'ProviderType'] != 'Null') or data['Specialty'] in common_spealities:
                                if not exist:
                                    writer.writerow(data.keys())
                                    exist = True
                                writer.writerow(data.values())
            ...
            for one_county in one_state_data.keys():
                ...
                for group in one_country_data.keys():
                    ...
                    for addresses in one_group_data.keys():
                        d = one_group_data[addresses]
                        for data in d:
                            if data['ProviderType'] in 'Facility':
                                if not exist:
                                    writer.writerow(data.keys())
                                    exist = True
                                writer.writerow(data.values())
...
#                         d = one_group_data[addresses]
#                         for data in d:
#                             if data['Specialty'] in facilities:
#                                 if not exist:
#                                     writer.writerow(data.keys())
#                                     exist = True
#                                 writer.writerow(data.values())
